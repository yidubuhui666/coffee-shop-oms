...
NEW_PRODUCTS = [
    # 气泡饮（3 款）
    ("气泡饮", "原味气泡水", "纯净苏打水 + 冰块，零卡解腻", 12, 150, "plain-sparkling.jpg", [
        ("苏打气泡水基底", 0.30), ("冷饮塑料杯", 1), ("杯盖", 1),
        ("吸管", 1), ("纸巾", 0.02),
    ]),
    ("气泡饮", "青柠气泡水", "苏打 + 鲜青柠 + 蜂蜜", 16, 120, "lime-sparkling.jpg", [
        ("苏打气泡水基底", 0.30), ("青柠", 0.5), ("蜂蜜", 0.010),
        ("冷饮塑料杯", 1), ("杯盖", 1), ("吸管", 1), ("纸巾", 0.02),
    ]),
    ("气泡饮", "莓果气泡水", "苏打 + 混合莓果糖浆 + 薄荷", 18, 100, "berry-sparkling.jpg", [
    ...
    # 超值套餐（4 款，原料 = 各商品原料之和）
    ("超值套餐", "元气早餐套餐",
     "美式咖啡 + 玛德琳，醒神又抗饿", 36, 80, "combo-breakfast.jpg", [
        # 美式咖啡
    ...
    ("超值套餐", "下午茶套餐",
     "拿铁 + 提拉米苏，慵懒午后", 52, 60, "combo-afternoon.jpg", [
        # 拿铁
    ...
    ("超值套餐", "商务能量套餐",
     "美式特浓 + 布朗尼，加班战神", 38, 60, "combo-business.jpg", [
        # 美式特浓
    ...
    ("超值套餐", "闺蜜双人套餐",
     "2 杯香草拿铁 + 1 块芝士蛋糕", 78, 40, "combo-duo.jpg", [
        # 2 杯香草拿铁
